...
let package = Package(
    ...
    products: [
        ...
        .library(name: "FinderScripting", targets: ["FinderScripting"]),
        ...
        .library(name: "PhotosScripting", targets: ["PhotosScripting"]),
        .library(name: "QuickTimePlayerScripting", targets: ["QuickTimePlayerScripting"]),
        .library(name: "RemindersScripting", targets: ["RemindersScripting"]),
        .library(name: "SafariScripting", targets: ["SafariScripting"]),
        .library(name: "ScreenSharingScripting", targets: ["ScreenSharingScripting"]),
        .library(name: "ShortcutsScripting", targets: ["ShortcutsScripting"]),
        .library(name: "SystemEventsScripting", targets: ["SystemEventsScripting"]),
    ...
    targets: [
        ...
        .target(name: "PhotosScripting", dependencies: ["SwiftScriptingBridge"], plugins: ["GenerateScriptingInterface"]),
        .target(name: "QuickTimePlayerScripting", dependencies: ["SwiftScriptingBridge"], plugins: ["GenerateScriptingInterface"]),
        ...
        .target(name: "ScreenSharingScripting", dependencies: ["SwiftScriptingBridge"], plugins: ["GenerateScriptingInterface"]),
        ...
        .target(name: "SystemEventsScripting", dependencies: ["SwiftScriptingBridge"], plugins: ["GenerateScriptingInterface"]),
